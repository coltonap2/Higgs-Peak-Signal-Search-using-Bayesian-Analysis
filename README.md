...
Of important note is the choice of the type of polynomial for $B_i$. This paper suggests that background events consistent with the diphoton channel follow a distribution that counts like a Bernstein polynomial of fourth degree, hence this specific choice, a choice that was not necessary in the four-lepton model. 
