...
println("\n" * "="^50)
println("  SIGNAL STRENGTH (μ) SUMMARY")
println("="^50)
println("Best-fit μ (mode, bat_findmode):  ", round(best_fit.mu, digits=4))
println("Posterior mean μ:                 ", round(mu_mean, digits=4))
println("Posterior median μ:               ", round(mu_median, digits=4))
println("Posterior std dev:                ", round(mu_std, digits=4))
println("68% credible interval:      [", round(mu_lower_68, digits=4), ", ", round(mu_upper_68, digits=4), "]")
println("95% credible interval:      [", round(mu_lower_95, digits=4), ", ", round(mu_upper_95, digits=4), "]")
println("="^50 * "\n")
...
vspan!([mu_lower_95, mu_upper_95], alpha=0.1, color=:red, label="95% CI")
